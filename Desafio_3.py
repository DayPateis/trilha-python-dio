...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\n **** Falha! Você não possui saldo o suficiente. ****")
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            print("\n **** Falha! Valor do saque maior que o permitido. ****")
            
        elif excedeu_saques:
            print("\n **** Falha! Você atingiu o número máximo de saques. ****")
...
def recuperar_conta_cliente(cliente):
    if not cliente.contas:
        print("\n **** Esse cliente não possui conta cadastrada! ****")
        return
...
def depositar(clientes):
    ...
    if not cliente:
        print("\n **** Falha! Cliente não localizado no sistema! ****")
        return
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\n****Falha! Cliente não localizado no sistema! Fluxo encerrado!****")
        return
